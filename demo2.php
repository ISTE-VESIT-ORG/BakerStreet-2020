    ...
    <script>
        ...
        function render(i){
            ...
            case 4:
                ...
                break;
            case 5:
                box.innerHTML = '<div class="col-4"><img src="ch1.png" alt="" ><h2>Character 1</h2></div><div class="col-8"><div class="rectangle-left">Look John,I am a consultant detective. People consult me to solve crimes.And it’s not vice versa</div><br><br><br><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
            case 6:
                ...
                break;
            case 7:
                box.innerHTML = '<div class="col-4"><img src="ch1.png" alt="" ><h2>Character 1</h2></div><div class="col-8"><div class="rectangle-left">Okay John, let’s do this one as your way.</div><br><br><br><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
            case 8:
                box.innerHTML = '<div class="col-4"><img src="ch1.png" alt="" ><h2>Character 1</h2></div><div class="col-8"><div class="rectangle-left">Okay ladies and gentlemen. First of all thank you for volunteering to help me.</div><br><br><br><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
            case 9:
