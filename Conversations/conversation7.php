...
?> 
  ...
  <div id="particles-js">
        ...
        function render(i){
            switch(i) {
            case 1:
                 box.innerHTML = '<div class="col-4"><img src="../images/sherlock.png" alt="" class="try"><h4>Sherlock</h4></div><div class="col-8"><div class="rectangle-left"> Okay Olivia everything’s fine. You are safe now</div><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
             ...
             case 2:
               ...
               box.innerHTML = '<div class="col-4"><img src="../images/sherlock.png" alt="" class="try"><h4>Sherlock</h4></div><div class="col-8"><div class="rectangle-left"> Okay Olivia, no problem. Just calm down we will take you back safely.</div><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 6:
                 box.innerHTML = '<div class="col-4"><img src="../images/sherlock.png" alt="" class="try"><h4>Sherlock</h4></div><div class="col-8"><div class="rectangle-left">We opened the note that we found in Olivia’s hand.</div><button class="btn btn-info button" onclick="back();">back</button></div>';
                break;
