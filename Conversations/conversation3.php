...
?> 
  ...
  <div id="particles-js">
        ...
        function render(i){
            switch(i) {
            case 1:
                box.innerHTML = '<div class="col-4"><img src="../images/sherlock.png" alt="" class="try"><h2>Sherlock</h2></div><div class="col-8"><div class="rectangle-left">Start an immediate search for the maid(Andrea).</div><br><br><br><br><br><br><br><br><br><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
            case 2:
                ...
                break;
            case 4:
                box.innerHTML = '<div class="col-4"><img src="../images/Carl.png " alt="class="try" ><h2>Carl </h2></div><div class="col-8"><div class="rectangle-left">   I don’t know,she hasn’t been home since last night. </div><br><br><br><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                 case 5:
                box.innerHTML = '<div class="col-8"><div class="rectangle-right"> Dont you care for your wife, she has not been home since last night and you seem not bothered about the fact that something might have happened to her ?</div><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div><div class="col-4"><img src="../images/Lestrade.png " alt="" width="80%" height="80%"><h2>Lestrade</h2></div>';
                break;
                 case 6:
                box.innerHTML = '<div class="col-4"><img src="../images/Carl.png class="try" alt="" ><h2>Carl </h2></div><div class="col-8"><div class="rectangle-left">Yeah youre right inspector, I dont care where she is. We are undergoing divorce. </div><br><br><br><br><br><br><br><br><br><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 7:
