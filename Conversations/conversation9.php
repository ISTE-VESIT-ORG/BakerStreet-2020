        ...
        function render(i){
            switch(i) {
             ...
             case 1:
                ...
                break;
                case 2:
                box.innerHTML = '<div class="col-4"><img src="" alt="" class="try"><h2>Erin</h2></div><div class="col-8"><div class="rectangle-left mb-5">Scarlett and I were head over heels over the same guy. I really wanted Scarlett to step back, but she wouldn’t. What was absurd was that over the next  few days I kept receiving calls from a man who knew about my jealousy and kept suggesting ways to get rid of Scarlett; always insisting on poison. I tried to get his identity by flirting with him over the telly but he wouldn’t budge and even threatened me with my life.</div><br><br><br><br><BR><button class="btn btn-info button" onclick="back();">back</button> <button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 3:
                ...
                break;
                case 4:
                box.innerHTML = '<div class="col-4"><img src="https://i.pinimg.com/236x/77/03/8a/77038a8120d63dfb1d5dd92ac2bc9041.jpg" alt="" class="try"><h2>Erin</h2></div><div class="col-8"><div class="rectangle-left">  No, I was scared. But I have to admit, heartbroken that I was, it was very tempting to just give in to his advice back then.Erin was handed over for further investigation.</div><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 5:
