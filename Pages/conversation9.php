        ...
        function render(i){
            switch(i) {
             ...
             case 1:
                ...
                break;
                case 2:
                box.innerHTML = '<div class="col-4"><img src="../images/erin.png" alt="" width="80%" height="80%"><h2>Erin</h2></div><div class="col-8"><div class="rectangle-left">  Scarlett and I were head over heels over the same guy. I really wanted Scarlett to step back, but she wouldn’t. What was absurd was that over the next  few days I kept receiving calls from a man who knew about my jealousy and kept suggesting ways to get rid of Scarlett; always insisting on poison. I tried to get his identity by flirting with him over the telly but he wouldn’t budge and even threatened me with my life.</div><br><br><br><br><br><br><br><br><br><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 3:
                ...
                break;
                case 4:
                box.innerHTML = '<div class="col-4"><img src="../images/erin.png" alt="" width="80%" height="80%"><h2>Erin</h2></div><div class="col-8"><div class="rectangle-left">  No, I was scared. But I have to admit, heartbroken that I was, it was very tempting to just give in to his advice back then.Erin was handed over for further investigation.</div><br><br><br><br><br><br><br><br><br><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
                case 5:
