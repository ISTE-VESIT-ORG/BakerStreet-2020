...
<body>
  ...
  <div id="particles-js">
        ...
        function render(i){
            switch(i) {
            case 1:
                box.innerHTML = '<div class="col-4"><img src="https://i.pinimg.com/236x/77/03/8a/77038a8120d63dfb1d5dd92ac2bc9041.jpg" alt="" width="80%" height="90%"><h2>Character 1</h2></div><div class="col-8"><div class="rectangle-left">Italy! We were really amazed to see the power of the kidnapper to take Olivia overseas.</div><br><br><br><br><br><br><br><br><br><button class="btn btn-primary button" onclick="change();">Next</button></div>';
                break;
